    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-8">
            ...
            {/* Телефон */}
            <TrackPhoneLink phone={phoneNumber} className="inline-flex items-center space-x-2 text-sm font-medium text-gray-900 hover:text-gray-700">
              <svg 
                className="w-5 h-5" 
                fill="none" 
                stroke="currentColor" 
      ...
      <div className={`lg:hidden ${isMenuOpen ? 'block' : 'hidden'}`}>
        <div className="pt-2 pb-3 space-y-1">
          ...
          {/* Телефон */}
          <TrackPhoneLink phone={phoneNumber} className="block pl-3 pr-4 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">
